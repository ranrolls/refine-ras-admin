<?php
/**
 * @package Content - Gallery JLEX plugin
 * @version 1.2.0
...
class Image {
	 ...
	 *        	(jpeg, png, bmp, gif, vnd.wap.wbmp, xbm)
	 */
	 ...
	 * @param string $method
	 *        	fit = Fits image into width and height while keeping original
	 *        	aspect ratio. Expect your image not to use the full area.
	 *        	crop = Crops image to fill the area while keeping original
	 *        	aspect ratio. Expect your image to get, well, cropped.
	 *        	fill = Fits image into the area without taking care of any
	 *        	ratios. Expect your image to get deformed.
	 *        	
	 ...
	 * @param int $oapcity        	
	 * @param int $marginH
	 *        	(margin in pixel from base image horizontally)
	 * @param int $marginV
	 *        	(margin in pixel from base image vertically)
	 *        	
