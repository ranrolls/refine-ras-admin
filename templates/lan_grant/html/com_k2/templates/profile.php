...
<?php /*?>	<?php if($this->params->def('show_page_title',1)): ?>
	...
	<div id="k2Container" class="k2AccountPage">
		<table class="admintable profile-edit" cellpadding="0" cellspacing="0">
			<?php /*?><tr>
			...
			<tr>
				...
				<td>
				User Name:	<span><b><?php echo $this->user->get('username'); ?></b></span>
				</td>
			</tr>
			<tr>
				<?php /*?><td class="key">
...
placeholder="password"/>
			...
			<tr>
				...
				<td>
					<input class="inputbox validate-passverify" type="password" id="password2" name="<?php echo $this->passwordVerifyFieldName; ?>" size="40" value="" placeholder="Verify password" />
				</td>
			</tr>
		...
		<div class="k2AccountPageUpdate">
			<button class="btn btn-primary btn-block" style="background-color:#224c9e; border-color: #224c9e; margin-top:10px;" type="submit" onclick="submitbutton( this.form );return false;">
