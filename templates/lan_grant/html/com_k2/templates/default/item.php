...
<div class="clearfix"></div>
  ...
  <div class="itemBody">
	  ...
	  <!-- Item Image -->
	  <div class="itemImageBlock col col-xs-12">
	  ...
	  <!-- Item fulltext -->
	  <div class="itemFullText col-xs-12">
...
<?php /*?>  <?php if($this->item->params->get('itemAuthorLatest') && empty($this->item->created_by_alias) && isset($this->authorLatestItems)): ?>
...
<?php /*?>  <?php if($this->item->params->get('itemNavigation') && !JRequest::getCmd('print') && (isset($this->item->nextLink) || isset($this->item->previousLink))): ?>
  <!-- Item navigation -->
