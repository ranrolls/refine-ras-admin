 ...
 <div class="clr"></div>
    ...
    <div class="catItemHeader">
	  ...
	  <h3 class="catItemTitle">
	  	...
	  	<?php if ($this->item->params->get('catItemTitleLinked')): ?>
			<a href="<?php echo $this->item->link; ?>" class="blue_text">
	  ...
	  <?php endif; ?>
		...
		<!-- Item Author -->
		<span class="catItemAuthor pull-left blue_text">
  ...
  <div class="catItemLinks">
		...
		<div class="catItemCategory pull-left">
			...
			<a href="<?php echo $this->item->category->link; ?>" class="blue_text"><?php echo $this->item->category->name; ?></a>
		</div>
		<?php endif; ?>
...
<!-- coment -->
	...
	<div class="catItemCommentsLink pull-left">
		...
		<?php else: ?>
			...
			<a href="<?php echo $this->item->link; ?>#itemCommentsAnchor" class="blue_text">
