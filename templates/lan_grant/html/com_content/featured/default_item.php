...
<?php echo $this->item->event->beforeDisplayContent; ?>
 ...
 <?php //$dataarticle= substr(strip_tags($this->item->introtext),0,310); //echo $dataarticle; ?>
  <? $dataarticle= strip_tags($this->item->introtext);

echo substr($dataarticle, 0, strrpos( substr( $dataarticle, 0, 315), ' ' ) ).'...'; ?>
...
<?php // Last Code if ($params->get('show_readmore') && $this->item->readmore) :
