	...
	public function register()
	{
		...
		{  
			...
			$this->setMessage(JText::_('COM_USERS_REGISTRATION_COMPLETE_ACTIVATE'));
                                ...
                                //header('Location: http://rasmentorshipforum.com/components/com_users/success.php');
                    
			$this->setRedirect(JRoute::_('index.php/components/com_users/success.php', false));
		}
		else
		{
                       //echo "vishal1";
