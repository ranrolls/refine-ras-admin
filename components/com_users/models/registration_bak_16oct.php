...
<tr>    <td height="20" align="left" valign="top"> <img src="http://'.$serverurl.'/images/banner123.jpg" alt=" " class="img" border="0" align="left" style="display:block;width:100%"></td>    </tr>
     ...
     <tr><td   align="center" valign="top">
       ...
       <tr><td align="left" valign="top"><p><span style="font-family:Arial, Helvetica, sans-serif; font-size:16px; line-height:20px; color:#343434; font-weight:normal;">Dear <span style="color:#f77635;text-transform:capitalize;">'.$data['name'].',</span><br /><br /> Welcome to RAS. Your registration process is successfully completed.<br /> 
         </span></p>
