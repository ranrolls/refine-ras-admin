			...
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-footer">
						<button id="noConfirmChangeCat" class="btn btn-default"><?php echo JText::_('COM_JUDIRECTORY_CLOSE'); ?></button>
						<button id="confirmChangeCat" class="btn btn-default btn-primary"><?php echo JText::_('COM_JUDIRECTORY_CONFIRM_AND_CHANGE'); ?></button>
					</div>
				</div>
			</div>
		</div>
