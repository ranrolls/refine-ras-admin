...
<fieldset class="adminform">
	<div id="related-listing-list" class="related-listing-list">
				...
				foreach ($this->relatedListings AS $listing)
				{
					...
					<li id="listing-<?php echo $listing->id; ?>">
						<div class="listing-inner">
							...
							<?php } ?>
							<a class="rel-listing-title" target="_blank"
							   href="index.php?option=com_judirectory&task=listing.edit&id=<?php echo $listing->id; ?>"><?php echo $listing->title; ?></a>
							<a class="remove-rel-listing" href="#"
							   title="<?php echo JText::_('COM_JUDIRECTORY_REMOVE_LISTING'); ?>"><?php echo JText::_('COM_JUDIRECTORY_REMOVE_LISTING'); ?></a>
		...
		<a class="modal btn btn-default btn-xs btn-primary add-listing" title="<?php echo JText::_('COM_JUDIRECTORY_ADD_LISTING'); ?>"
		   href="<?php echo $link . '&amp;' . JSession::getFormToken(); ?>=1"
		   rel="{handler: 'iframe', size: {x: 800, y: 450}}"><i class="fa fa-plus"></i> <?php echo JText::_('COM_JUDIRECTORY_ADD_LISTING'); ?>
		</a>
	</div>
</fieldset>