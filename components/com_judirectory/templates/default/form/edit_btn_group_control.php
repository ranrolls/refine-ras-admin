...
if ($this->approvalForm)
{
	...
	<div class="judir-submit-buttons">
		<button type="button" class="btn btn-default btn-primary" onclick="Joomla.submitbutton('modpendinglisting.save')">
			<i class="fa fa-save"></i> <?php echo JText::_('COM_JUDIRECTORY_SUBMIT'); ?>
		</button>
		<button type="button" class="btn btn-default" onclick="Joomla.submitbutton('modpendinglisting.cancel');">
		...
		<div class="judir-approval-inner">
			...
			<div class="judir-approval-options">
				<div class="judir-option-approve-item input-prepend input-append pull-left">
					...
					<label for="ignore-listing" class="btn btn-default">
				...
				<div class="judir-option-approve-item input-prepend input-append pull-left">
					...
					<label for="approval-listing" class="btn btn-default btn-success">
