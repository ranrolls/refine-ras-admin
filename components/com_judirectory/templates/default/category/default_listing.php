...
?>
	...
	<div  id="<?php echo $this->item->id;?>" class="<?php echo $item_class; ?>" data-list-class="col-md-12" data-grid-class="col-md-<?php echo $listing_grid_col; ?>">
	<?php
...
$titleField = isset($fields['title']) ? $fields['title'] : null;
	...
	{  
		...
		<h3 class="listing-title">
			...
			//echo $titleField->getDisplayPrefixText() . " " . $titleField->getOutput(array()) . " " . $titleField->getDisplaySuffixText();
