...
$linkCreateListing = JRoute::_(JUDirectoryFrontHelperListing::getAddListingLink());
							...
							<div>
								<a href="<?php echo $linkUserProfile ?>"><?php echo JText::_('COM_JUDIRECTORY_EDIT_USER_PROFILE'); ?></a>
						     	<form class="logout" action="#" method="post">
									<input type="submit" value="Logout" class="btn btn-default btn-success"/>
		...
		<div class="pull-left">
			...
			<div class="dashboard-actions">
				<a href="<?php echo $linkCreateListing ?>"
				   class="btn btn-default btn-sm"><?php echo JText::_('COM_JUDIRECTORY_ADD_LISTING'); ?></a>
				<a href="<?php echo $linkUserProfile ?>"
				   class="btn btn-default btn-sm"><?php echo JText::_('COM_JUDIRECTORY_EDIT_PROFILE'); ?></a>
			</div>
		</div>
	</div>
<?php
