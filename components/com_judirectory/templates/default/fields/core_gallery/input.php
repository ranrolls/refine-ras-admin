...
$small_image_dir = JUDirectoryFrontHelper::getDirectory("listing_small_image_directory", "media/com_judirectory/images/gallery/small/", true) . $this->doc_id . "/";
...
<script id="gallery-template" type="text/x-handlebars-template">
	<li>
		...
		<a href="#" class="btn btn-xs btn-xs btn-danger remove_image" onclick="return false;"><i class="fa fa-minus-circle"></i> <?php echo JText::_('COM_JUDIRECTORY_REMOVE'); ?></a>
	</li>
</script>

<!-- Gallery image form template -->
<script id="imageform-template" type="text/x-handlebars-template">
	<div id="img-element-data-form" class="img-element-data-form" style="float: left">
		<div class="form-horizontal" style="margin: 10px">
			<div class="form-group" >
				<label for="imgtitle" class="control-label col-xs-2"><?php echo JText::_('COM_JUDIRECTORY_FIELD_TITLE'); ?></label>
				<div class="col-xs-10" >
					<input type="text" name="imgtitle" id="imgtitle" value="{{image.title}}" size="50" />
				</div>
			</div>
			<div class="form-group" >
				<label for="imgdescription" class="control-label col-xs-2"><?php echo JText::_('COM_JUDIRECTORY_FIELD_DESCRIPTION'); ?></label>
				<div class="col-xs-10" >
					<textarea rows="5" cols="47" style="width: auto; height: auto" name="imgdescription" id="imgdescription" >{{image.description}}</textarea>
				</div>
			</div>
			<div class="form-group">
				<label for="imgdescription" class="control-label col-xs-2"><?php echo JText::_('COM_JUDIRECTORY_FIELD_PUBLISHED'); ?></label>
				<div class="col-xs-10" >
			...
			<div class="form-group" style="margin-bottom: 0">
				<div class="col-xs-offset-2 col-xs-10" >
					<input class="btn" onclick="updateImageData(); return false;" type="button" value="<?php echo JText::_('COM_JUDIRECTORY_UPDATE'); ?>" />
					<input class="btn" onclick="imageFormClose(); return false;" type="button" value="<?php echo JText::_('COM_JUDIRECTORY_CANCEL'); ?>" />
				</div>
			</div>
		</div>
	</div>
...
<div id="image-gallery" class="jugallery-holder">
			...
			foreach ($images AS $key => $image)
			{
				...
				<li data-itemid="<?php echo $image['id'] ?>">
					<div class="img-element<?php echo $class; ?>">
						...
						<input type="hidden" class="title-image-value" value="<?php echo htmlspecialchars($image['title'], ENT_QUOTES) ?>"
	...
	<a href="#" class="btn btn-default btn-xs btn-primary add_images" id="add_images" onclick="return false;"
		title="<?php echo JText::_('COM_JUDIRECTORY_PLEASE_UPLOAD_AN_IMAGE'); ?>"><i
			class="fa fa-plus"></i> <?php echo JText::_('COM_JUDIRECTORY_ADD_IMAGE'); ?>
	</a>
