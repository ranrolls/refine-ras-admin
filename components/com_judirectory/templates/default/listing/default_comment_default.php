...
if ($this->item->params->get('access-comment'))
{
	...
	<div class="comment-form-container clearfix">
		<form name="judir-comment-form" id="judir-comment-form" class="form-validate comment-form form-horizontal" method="post" action="">
			<fieldset>
				...
				<div class="judir-comment-wrapper clearfix">
						...
						<div class="comment-body">
							<div class="comment-row">
								<label for="comment-editor"><?php echo JText::_('COM_JUDIRECTORY_COMMENT'); ?>
									<span class="required">*</span></label>
									<textarea name="comment" class="required validate-comment comment-editor form-control" id="comment-editor"
										rows="8"><?php echo $this->comment; ?></textarea>
							</div>
							<?php
					...
					<div class="comment-form-submit clearfix">
						...
						<button name="comment-reset" type="reset"
						        class="btn btn-default"><?php echo JText::_('COM_JUDIRECTORY_RESET'); ?></button>
					</div>
