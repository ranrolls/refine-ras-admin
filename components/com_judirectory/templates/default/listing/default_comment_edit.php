			...
			<div class="judir-comment-wrapper clearfix">
				...
				<div class="judir-comment">
					...
					<div class="comment-header">
						<div class="comment-user-info col-md-8">
						...
						{
							echo '<div class="comment-rating col-md-4">';
							echo $this->item->fields['rating']->getOutput(array("view" => "details", "template" => $this->template, "type" => "comment_form", "prefixId"=>'edit-', "comment_object" => $this->commentObj));
							echo '</div>';
						}
						?>
					</div>
					...
					<div class="comment-body">
						...
						<div class="comment-row">
								<textarea class="required validate-comment comment-editor form-control"
					...
					<div class="comment-form-submit clearfix">
						...
						<button type="button" class="btn btn-default btn-danger cancel-edit-comment"
							onclick="judirCancelEditComment('<?php echo $this->commentObj->id; ?>'); return false;"><?php echo JText::_('COM_JUDIRECTORY_CANCEL'); ?>
						</button>
					</div>
