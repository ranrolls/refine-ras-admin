...
<div class="actions clearfix">
	...
	<?php if ($this->item->params->get('access-report'))
	{
		...
		<span class="action-report">
			<?php echo '<a href="' . $this->item->report_link . '" title="' . JText::_('COM_JUDIRECTORY_REPORT') . '" class="hasTooltip report-task btn btn-default"><i class="fa fa-warning"></i></a>'; ?>
		</span>
	<?php
	}
	...
	if ($this->item->params->get('access-contact'))
	{
		...
		<span class="action-contact">
			<?php echo '<a href="' . $this->item->contact_link . '" title="' . JText::_('COM_JUDIRECTORY_CONTACT') . '" class="hasTooltip btn btn-default"><i class="fa fa-user"></i></a>'; ?>
		</span>
	<?php
	}
	...
	<span class="action-claim">
		<?php
		echo '<a class="hasTooltip btn btn-default" title="' . JText::_('COM_JUDIRECTORY_CLAIM') . '" href="' . $this->item->claim_link . '"><i class="fa fa-flag" ></i></a>';
		?>
	</span>
	<?php
	} ?>
	...
	<span class="action-print">
		<?php
			...
			echo '<a class="hasTooltip btn btn-default" title="' . JText::_('COM_JUDIRECTORY_PRINT') . '" href="' . $this->item->print_link . '" rel="nofollow" onclick="' . $onclick . '"><i class="fa fa-print" ></i></a>';
		?>
	</span>

	<span class="action-mailtofriend">
		<a href="#judir-mailtofriend"
		   title="<?php echo JText::_('COM_JUDIRECTORY_SEND_EMAIL_TO_FRIEND'); ?>" class="hasTooltip btn btn-default"
	...
	<?php if ($this->collection_popup)
	{
		...
		<span class="action-addcollection">
	            <a class="hasTooltip btn btn-default judir-add-collection"
				...
				<div class="modal-content">
					...
					<form action="#" method="post" name="create-new-collection" class="form-horizontal">
						<div class="modal-body">
							<div class="form-group">
								<label class="control-label col-sm-2"><?php echo JText::_("COM_JUDIRECTORY_FIELD_TITLE"); ?>
							...
							<div class="form-group">
								<label
									class="control-label col-sm-2"><?php echo JText::_("COM_JUDIRECTORY_FIELD_DESCRIPTION"); ?></label>
							...
							<div class="form-group">
								<label
									class="control-label col-sm-2"><?php echo JText::_("COM_JUDIRECTORY_FIELD_PRIVATE"); ?></label>
