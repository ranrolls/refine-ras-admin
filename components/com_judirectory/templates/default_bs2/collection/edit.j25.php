...
?>
<div id="judir-container" class="jubootstrap component judir-container judir-form">
	<form
		...
		<div class="collection-search-listings">
			...
			<button type="submit" class="btn" id="add-listing-to-collection"><?php echo JText::_("COM_JUDIRECTORY_ADD_LISTING"); ?></button>
		</div>
		...
		<div class="judir-submit-buttons">
			<button type="button" class="btn btn-primary" id="save-edit-collection-button">
				<i class="fa fa-save"></i> <?php echo JText::_('COM_JUDIRECTORY_SUBMIT'); ?>
			</button>

			<button type="button" class="btn" onclick="Joomla.submitbutton('collection.cancel')">
