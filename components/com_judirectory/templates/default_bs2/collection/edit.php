...
?>
<div id="judir-container" class="jubootstrap component judir-container view-collection layout-edit judir-form"">
	<form
		...
		{
			echo JHtml::_('bootstrap.startTabSet', 'judirectory', array('active' => 'details'));
			echo JHtml::_('bootstrap.addTab', 'judirectory', 'details', JText::_('COM_JUDIRECTORY_COLLECTION_DETAILS'));
		...
		{
			echo JHtml::_('bootstrap.startTabSet', 'judirectory', array('active' => 'listings'));
		}
		echo JHtml::_('bootstrap.addTab', 'judirectory', 'listings' , JText::_('COM_JUDIRECTORY_LISTINGS'));
		?>
		<h4 class="text-right">
						...
						<td>
							...
							if (isset($imageFieldd) &$imageFieldld->canView())
							{
								...
								<div class="collection-item-icon">
									<?php echo $imageFieldeld->getOutput(array('view' => "list")); ?>
								</div>
							<?php
							}
							?>
