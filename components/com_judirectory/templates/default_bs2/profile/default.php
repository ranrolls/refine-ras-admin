			...
			<div class="control-group">
				<div class="controls">
					<button type="button" onclick="Joomla.submitbutton('profile.save')"
					   class="btn btn-primary"> <?php echo JText::_('COM_JUDIRECTORY_SUBMIT'); ?></button>
					<button type="button" onclick="Joomla.submitbutton('profile.cancel')"
					   class="btn"> <?php echo JText::_('COM_JUDIRECTORY_CANCEL'); ?></button>
				</div>
			</div>
		</fieldset>
