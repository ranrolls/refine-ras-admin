...
<div id="judir-container"
	class="jubootstrap component judir-container view-tree<?php echo $this->pageclass_sfx; ?> category-<?php echo $this->category->id; ?> <?php echo isset($this->tl_catid) ? 'tlcat-id-' . $this->tl_catid : ""; ?> <?php echo $this->category->class_sfx; ?>">
