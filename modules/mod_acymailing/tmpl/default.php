...
<?php
	...
	<div class="acymailing_fulldiv" id="acymailing_fulldiv_<?php echo $formName; ?>" <?php echo $styleString; ?> >
		...
		<div class="acymailing_module_form" style="">
			...
			<table align="left" class="acymailing_form" >
        <!--     <tr>  <span class="subc_news pull-left">Subscribe our Newsletter</span></tr> -->
	<tr>
    ...
    <tr>
						<?php }else{
							...
							?>
					<table align="left" class="acymailing_lists">
						<?php foreach($visibleListsArray as $myListId){
							$check = in_array($myListId,$checkedListsArray) ? 'checked="checked"' : '';
    ...
    <tr>
					...
					<td align="left" class="acysubbuttons" <?php if($displayOutside AND !$displayInline) echo 'colspan="2"'; ?>>
