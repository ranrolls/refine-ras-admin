...
<ul class="featcats<?php echo $moduleclass_sfx; ?>" id="featcats-<?php echo $mid; ?>">
    ...
    <li class="<?php echo $cat->col_class; ?>" style="width:<?php echo $params->get('col_width'); ?>" id="featcat-<?php echo $mid; ?>-<?php echo $id; ?>">
        ...
        <?php if ($params->get('cat_image') && $cat->category_image) : ?>
			...
			<img src="<?php echo JURI::base(false).$cat->category_image; ?>" class="fc_cat_image pull-left" />
            <?php if ($link_cats) : ?></a><?php endif; ?>
        <?php endif; ?>
        <?php if ($cat_heading) : ?><?php echo '<h' . $cat_heading . '>'; ?><?php if ($link_cats) : ?><a href="<?php echo $cat->category_link; ?>" class="pull-left blue_text"><?php endif; ?><?php echo $cat->category_title; ?><?php if ($link_cats) : ?></a><?php endif; ?><?php echo '</h' . $cat_heading . '>'; ?><?php endif; ?>
		<?php if ($cat->articles) : ?>
        <div class="clearfix"></div>
			<div id="fc_ajax-<?php echo $mid; ?>-<?php echo $id; ?>" class="fc_ajax pull-left" >
