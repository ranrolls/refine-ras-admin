...
<?php
	...
	$doc->addStyleSheet('http://fonts.googleapis.com/css?family=' .$googlecode, 'text/css', 'all');
...
<style scoped type="text/css">
	...
	right:0;
	height:20px;
	background: url(modules/mod_joomspirit_slider/assets/css/images/shadow-top-<?php echo $shadow_top_image ; ?>.png) 0 0 repeat-x;
	z-index:7;
	}
	<?php endif; ?>
	...
	right:0;
	height:20px;
	background: url(modules/mod_joomspirit_slider/assets/css/images/shadow-bottom-<?php echo $shadow_bottom_image ; ?>.png) 0 0 repeat-x;
	z-index:7;
	}
	<?php endif; ?>
	...
	@media screen and (min-width: 980px) {
		...
		position:relative;
		min-height: <?php echo $height_slideshow_desktop_percentage ; ?>vh;
		top : <?php echo ($height_slideshow_desktop_percentage / 2) ; ?>vh;
	...
	@media screen and (min-width: 980px) {
		...
		.flexslider .slides img {
		position:relative;
		min-height: <?php echo $height_slideshow_desktop_px ; ?>px;
		top : <?php echo ($height_slideshow_desktop_px / 2) ; ?>px;
		-webkit-transform: translateY(-50%) translateX(-50%);
		-ms-transform: translateY(-50%) translateX(-50%);
		transform: translateY(-50%) translateX(-50%);
		width:auto;
	...
	@media screen and (max-width: 979px) and (min-width: 768px) {
		...
		.flexslider .slides img {
		position:relative;
		min-height: <?php echo $height_slideshow_tablet_percentage ; ?>vh;
		top : <?php echo ($height_slideshow_tablet_percentage / 2) ; ?>vh;
		-webkit-transform: translateY(-50%) translateX(-50%);
		-ms-transform: translateY(-50%) translateX(-50%);
		transform: translateY(-50%) translateX(-50%);
		width:auto;
	...
	@media screen and (max-width: 979px) and (min-width: 768px) {
		...
		.flexslider .slides img {
		position:relative;
		min-height: <?php echo $height_slideshow_tablet_px ; ?>px;
		top : <?php echo ($height_slideshow_tablet_px / 2) ; ?>px;
		-webkit-transform: translateY(-50%) translateX(-50%);
		-ms-transform: translateY(-50%) translateX(-50%);
		transform: translateY(-50%) translateX(-50%);
		width:auto;
	...
	@media screen and (max-width: 767px) {
		...
		.flexslider .slides img {
		position:relative;
		min-height: <?php echo $height_slideshow_phone_percentage ; ?>vh;
		top : <?php echo ($height_slideshow_phone_percentage / 2) ; ?>vh;
		-webkit-transform: translateY(-50%) translateX(-50%);
		-ms-transform: translateY(-50%) translateX(-50%);
		transform: translateY(-50%) translateX(-50%);
		width:auto;
	...
	@media screen and (max-width: 767px) {
		...
		.flexslider .slides img {
		position:relative;
		min-height: <?php echo $height_slideshow_phone_px ; ?>px;
		top : <?php echo ($height_slideshow_phone_px / 2) ; ?>px;
		-webkit-transform: translateY(-50%) translateX(-50%);
		-ms-transform: translateY(-50%) translateX(-50%);
		transform: translateY(-50%) translateX(-50%);
		width:auto;
