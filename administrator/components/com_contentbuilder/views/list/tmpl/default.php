...
<form action="index.php" method="<?php echo $___getpost;?>" name="adminForm" id="adminForm" onsubmit="return false">
<div id="editcell">
    <table class="cbFilterTable" width="100%">
        ...
        <tr>
            ...
            <td>
                ...
                <button class="button btn btn-secondary cbButton cbSearchButton cbFieldFix" onclick="document.adminForm.submit();"><?php echo JText::_('COM_CONTENTBUILDER_SEARCH') ?></button>
