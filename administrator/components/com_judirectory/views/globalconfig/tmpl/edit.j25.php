...
<div class="jubootstrap">
	...
	<form action="<?php echo JRoute::_('index.php?option=com_judirectory&view=globalconfig&layout=edit'); ?>" enctype="multipart/form-data" method="post" name="adminForm" id="adminForm" class="form-validate judirectory-config">
		<?php
