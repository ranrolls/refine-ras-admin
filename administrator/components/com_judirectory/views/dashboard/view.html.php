...
class JUDirectoryViewDashboard extends JUDIRViewAdmin
{
	...
	{
		JToolBarHelper::title(JText::_('COM_JUDIRECTORY_DASHBOARD'), 'dashboard');
	...
	protected function setDocument()
	{
		...
		$document->setTitle(JText::_('COM_JUDIRECTORY_DASHBOARD'));
	}
}
