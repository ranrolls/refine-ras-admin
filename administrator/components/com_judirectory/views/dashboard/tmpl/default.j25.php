...
if (JUDirectoryHelper::checkGroupPermission(null, "globalconfig"))
{
	...
	<div class="cpanel">
		<div class="icon-wrapper">
			<div class="icon">
				<a href="<?php echo JRoute::_('index.php?option=com_judirectory&view=globalconfig&layout=edit', false); ?>">
...
<?php
echo JHtml::_('sliders.start', 'statics', array('useCookie' => 1));
echo JHtml::_('sliders.panel', JText::_('COM_JUDIRECTORY_TOP_5'), 'top-5-sliders');
echo JHtml::_('tabs.start', 'top-5', array('useCookie' => 1));
echo JHtml::_('tabs.panel', JText::_('COM_JUDIRECTORY_LAST_ADDED_LISTING'), 'core_fields');
?>
...
<?php
echo JHtml::_('tabs.panel', JText::_('COM_JUDIRECTORY_LAST_ADDED_COMMENTS'), 'last-comment');
?>
<table class="adminlist table table-striped">
	<thead>
	<tr>
...
<!--  Last updated -->
<?php
echo JHtml::_('tabs.panel', JText::_('COM_JUDIRECTORY_LAST_UPDATED_LISTINGS'), 'last-updated');
?>
<table class="adminlist table table-striped">
	<thead>
	<tr>
...
<!--  popular listing -->
<?php
echo JHtml::_('tabs.panel', JText::_('COM_JUDIRECTORY_POPULAR_LISTINGS'), 'popular-listings');
?>
<table class="adminlist table table-striped">
	<thead>
	<tr>
	...
	foreach ($popularListings AS $listing)
	{
		...
		<tr>
			...
			<td class="center"><?php echo $listing->hits; ?></td>
			<td class="center"><?php echo $listing->created; ?></td>
			<td class="center"><?php echo $listing->modified; ?></td>
			<td class="center"><?php echo JHtml::_('grid.boolean', $listing->id, $listing->published); ?></td>
		</tr>
	<?php
	} ?>
...
<!--  Static -->
<?php
echo JHtml::_('tabs.panel', JText::_('COM_JUDIRECTORY_STATISTICS'), 'static');
?>
<table class="adminlist table table-striped">
	<thead>
	<tr>
...
if(JUDIRPROVERSION)
{
	echo JHtml::_('sliders.start', 'chart', array('useCookie' => 1));
	echo JHtml::_('sliders.panel', JText::_('COM_JUDIRECTORY_CHART'), 'chart');
