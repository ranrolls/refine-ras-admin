...
<script type="text/javascript">
	Joomla.submitbutton = function (task) {
		if (task == 'criteria.cancel' || document.formvalidator.isValid(document.id('adminForm'))) {
	...
	<form action="<?php echo JRoute::_('index.php?option=com_judirectory&layout=edit&id=' . (int) $this->item->id); ?>" method="post" name="adminForm" id="adminForm" class="form-validate">
		<div class="width-60 fltlft">
			<fieldset class="adminform">
				<legend><?php echo JText::_('COM_JUDIRECTORY_EDIT_CRITERIA'); ?></legend>
		...
		<div class="width-40 fltrt">
			<?php echo JHtml::_('sliders.start', 'criteria-sliders-' . $this->item->id, array('useCookie' => 1)); ?>
