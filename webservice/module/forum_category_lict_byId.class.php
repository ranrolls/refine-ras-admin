...
Class forum_category_lict_byId{
    ...
    $rs123 = $dbObj->runQuery("SELECT * FROM ras_kune na_topics  where category_id = '".$_REQUEST['forumId']."' ORDER BY first_post_time ASC  ");
...
FROM `ras_kunena_messages` WHERE `thread` ='".$tempArray['topic_id']."' AND `catid` ='".$tempArray['category_id']."' order by time DESC   ");
